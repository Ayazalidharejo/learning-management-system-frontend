...
const SuperAdminDashboard = () => {
  ...
  return (
//     <div className="superadmin-dashboard bg-light min-vh-100">
//   <Navbar />
//   <div className="container py-5">
//     <div className="card shadow-lg border-0 mb-5">
//       <div className="card-header bg-primary text-white p-4">
//         <h1 className="text-center mb-0 fw-bold">Super Admin Dashboard</h1>
//       </div>
      
//       <div className="card-body p-4">
//         <div className="bg-light p-4 rounded-3 mb-4 shadow-sm border-start border-5 border-primary">
//           <h4 className="text-primary fw-bold">Welcome, {user?.name}</h4>
//           <div className="d-flex gap-4 mt-2">
//             <p className="mb-0"><i className="bi bi-envelope-fill me-2"></i>Email: {user?.email}</p>
//             <p className="mb-0"><i className="bi bi-person-badge-fill me-2"></i>Role: <span className="badge bg-primary">Super Admin</span></p>
//           </div>
//         </div>
...
//                 <div className="row g-4">
//                   {courses.map(course => (
//                     <div key={course._id} className="col-md-6 col-lg-6">
...
//                           <h5 className="card-title text-primary mb-0 fw-bold">{course.name}</h5>
//                         </div>
//                         <div className="card-body">
...
//                                 <div key={student._id} className="list-group-item list-group-item-action d-flex justify-content-between align-items-center border-0 bg-light mb-2 rounded">
//                                   <div>
...
//                               <span className="bg-primary bg-opacity-10 text-primary rounded-circle d-inline-flex align-items-center justify-content-center me-3" style={{ width: '40px', height: '40px' }}>
  ...
  <div className="container-fluid container-lg py-3 py-md-4 py-lg-5">
    <div className="card shadow-lg border-0 mb-4 mb-lg-5">
      <div className="card-header bg-primary text-white p-3 p-md-4">
        <h1 className="text-center mb-0 fw-bold fs-3 fs-md-2 fs-lg-1">Super Admin Dashboard</h1>
      </div>
      
      <div className="card-body p-3 p-md-4">
        <div className="bg-light p-3 p-md-4 rounded-3 mb-4 shadow-sm border-start border-5 border-primary">
          <h4 className="text-primary fw-bold">Welcome, {user?.name}</h4>
                ...
                <div className="row g-3 g-lg-4">
                  {courses.map(course => (
                    <div key={course._id} className="col-12 col-md-6">
                      <div className="card h-100 shadow-sm border-0 hover-shadow transition">
                        <div className="card-header bg-primary bg-opacity-10 py-3">
                          <h5 className="card-title text-primary mb-0 fw-bold fs-6 fs-md-5">{course.name}</h5>
                        </div>
                        <div className="card-body p-3">
                          ...
                          {course.students?.length > 0 ? (
                            <div className="list-group mt-3">
                              {course.students.map(student => (
                                <div key={student._id} className="list-group-item list-group-item-action d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center border-0 bg-light mb-2 rounded p-2 p-sm-3">
                      ...
                      {users.map(u => (
                        <tr key={u._id}>
                          <td className="px-2 px-md-4 py-2 py-md-3 align-middle">
                            <div className="d-flex align-items-center">
                              <span className="bg-primary bg-opacity-10 text-primary rounded-circle d-inline-flex align-items-center justify-content-center me-2 me-md-3" style={{ width: '32px', height: '32px', minWidth: '32px' }}>
                                {u.name.charAt(0).toUpperCase()}
                              </span>
